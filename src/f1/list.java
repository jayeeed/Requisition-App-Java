...
public final class list extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ItBD");

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("ItOS");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(src, javax.swing.GroupLayout.PREFERRED_SIZE, 211, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(64, 64, 64)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(ito)
                    .addComponent(no, javax.swing.GroupLayout.DEFAULT_SIZE, 416, Short.MAX_VALUE)
                    .addComponent(itb))
                .addGap(18, 18, 18)
        ...
        setSize(new java.awt.Dimension(1305, 683));
    ...
    private void TableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TableMouseClicked
        ...
        no.setText((String) model.getValueAt(i, 0));
        itb.setText((String) model.getValueAt(i, 12));
        ito.setText((String) model.getValueAt(i, 13));
    ...
    private void srcKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_srcKeyReleased
        ...
        try{
            ...
            String sql="SELECT No, User, Date, Department, Device, Item, Model, Qty, Unit, Remarks, Price, Duration, ItBD, ItOS FROM f1 WHERE No LIKE '%"+src.getText()+"%'";
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sql = "UPDATE `f1` SET `ItBD`='"+ITBD+"',`ItOS`='"+ITOS+"' WHERE No = '"+NO+"'";
